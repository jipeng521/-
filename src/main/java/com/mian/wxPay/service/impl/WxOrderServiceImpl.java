package com.mian.wxPay.service.impl;


import com.mian.wxPay.config.WeChatConfig;
import com.mian.wxPay.entity.PayResult;
import com.mian.wxPay.entity.PreOrder;
import com.mian.wxPay.entity.PreOrderResult;
import com.mian.wxPay.service.WxOrderService;
import com.mian.wxPay.util.DateUtil;
import com.mian.wxPay.util.HttpUtil;
import com.mian.wxPay.util.Sign;
import com.mian.wxPay.util.XmlUtil;
...
public class WxOrderServiceImpl implements WxOrderService {
	...
	public PreOrderResult placeOrder(String body, String out_trade_no, String total_fee) throws Exception {
		...
		o.setExpireTime(DateUtil.getOrderExpireTime(2*60*1000L));//设置两分钟过期
		...
		p.put("time_expire", DateUtil.getOrderExpireTime(2*60*1000L));//这边也设置两分钟过期
		// 获得签名
